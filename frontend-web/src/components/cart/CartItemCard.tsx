...
export function CartItemCard({
  ...
  return (
    <div className="p-4 md:px-6 flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 transition-colors hover:bg-muted/10">
      ...
      {/* Lado Direito: Ações (Qtd + Excluir) + Subtotal (Extremidade Direita no Mobile e Desktop) */}
      <div className="flex items-center justify-between sm:justify-end gap-3 sm:gap-6 shrink-0 pt-2.5 sm:pt-0 border-t sm:border-t-0 border-border/40">
        ...
        {/* Subtotal do Item (Sempre na borda direita, alinhando com SUBTOTAL do cabeçalho) */}
