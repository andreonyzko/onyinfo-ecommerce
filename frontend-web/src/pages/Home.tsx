...
import { ArrowRight, Cpu, ShieldCheck, Truck, Zap, Sparkles, LayoutGrid, Package } from 'lucide-react'
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-8 space-y-5 text-left">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-primary/20 bg-primary/10 text-primary text-xs font-semibold">
                ...
                <span>Hardware de Última Geração</span>
              </div>
              ...
              <p className="text-sm sm:text-base text-muted-foreground max-w-2xl leading-relaxed">
                Encontre os melhores processadores, placas de vídeo, memórias e periféricos com garantia oficial,
                envio rápido para todo o Brasil e preços imbatíveis para o seu setup gamer ou profissional.
              </p>
            ...
            <div className="lg:col-span-4 grid grid-cols-2 gap-3 sm:gap-4">
              ...
              <div className="p-4 rounded-xl border border-border bg-card/80 backdrop-blur-xs shadow-xs space-y-1">
                ...
                <div className="text-lg font-black text-foreground">Envio Rápido</div>
                <p className="text-xs text-muted-foreground">Entrega em todo o Brasil</p>
              </div>

              <div className="p-4 rounded-xl border border-border bg-card/80 backdrop-blur-xs shadow-xs space-y-1">
                <Cpu className="w-5 h-5 text-emerald-500 mb-2" />
                <div className="text-lg font-black text-foreground">{totalProductsCount} Produtos</div>
                <p className="text-xs text-muted-foreground">Em 16 departamentos</p>
              </div>

              <div className="p-4 rounded-xl border border-border bg-card/80 backdrop-blur-xs shadow-xs space-y-1">
                <ShieldCheck className="w-5 h-5 text-violet-500 mb-2" />
                <div className="text-lg font-black text-foreground">100% Confiável</div>
                <p className="text-xs text-muted-foreground">Garantia e suporte especializado</p>
              </div>
            </div>
          </div>
        </div>
