                ...
                <div className="flex items-center gap-3.5 min-w-0">
                  ...
                  <div className="min-w-0 space-y-0.5">
                    ...
                    <div className="text-xs text-muted-foreground flex items-center gap-2">
                      ...
                      <span>Qtd: <strong>{quantity}</strong></span>
                      <span>&bull;</span>
            ...
            <div className="p-4 rounded-xl border border-border/70 bg-muted/20 space-y-2 text-xs">
              ...
              <div className="text-muted-foreground space-y-0.5 leading-relaxed">
                <p className="font-medium text-foreground flex items-center gap-1">
                  ...
                  <span>{order.customer.name} (CPF: {order.customer.cpf})</span>
                </p>
                <p>{order.address.street}, {order.address.number}{order.address.complement ? ` - ${order.address.complement}` : ''}</p>
                <p>{order.address.neighborhood} &bull; {order.address.city} - {order.address.state}</p>
              ...
              <div className="pt-2 border-t border-border/60 flex items-center gap-1.5 text-xs font-semibold text-primary">
                ...
                <span>Modalidade: {order.shippingOption.name} ({order.shippingOption.deadlineDays === 0 ? 'Retirada imediata' : `até ${order.shippingOption.deadlineDays} dias úteis`})</span>
              </div>
            </div>
